...
import org.jvnet.mimepull.MIMEConfigYM;
...
public class MultiPartPartialReader implements MessageBodyReader<MultiPart> {
     ...
     * MIME configuration.
     */
    private final MIMEConfigYM mimeConfig;
    ...
    public MultiPartPartialReader() {
        ...
        mimeConfig = createMimeConfig(properties, false);
    }
     ...
     */
    private MIMEConfigYM createMimeConfig(final MultiPartProperties properties, final boolean enablePartial) {
        final MIMEConfigYM mimeConfig = new MIMEConfigYM();
