...
/* FROM mail.jar */
final class MimeUtilityPartial {

    // This class cannot be instantiated
    /**
     * No change. Private Constructor.
     */
    private MimeUtilityPartial() { }

    /** ignoreUnknownEncoding boolean. */
     ...
     */
    public static InputStream decode(final InputStream is, final String encoding, final boolean isPartial)
        throws DecodingException {
        if (encoding.equalsIgnoreCase("base64")) {
            if (isPartial) {
                return new BASE64DecoderStreamPartial(is, isPartial);
            }
            return new BASE64DecoderStream(is);
        }
        else if (encoding.equalsIgnoreCase("quoted-printable")) {
            if (isPartial) {
                return new QPDecoderStreamPartial(is, isPartial);
            }
            ...
            if (isPartial) {
                return new UUDecoderStreamPartial(is, isPartial);
            }
