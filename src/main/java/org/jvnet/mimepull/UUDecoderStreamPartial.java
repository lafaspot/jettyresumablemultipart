...
final class UUDecoderStreamPartial extends FilterInputStream {
    private String name;
    private int mode;
     ...
     */
    public UUDecoderStreamPartial(InputStream in, final boolean isPartial) {
        super(in);
     ...
     */
    public UUDecoderStreamPartial(InputStream in, boolean ignoreErrors, boolean ignoreMissingBeginEnd, final boolean isPartial) {
        super(in);
        lin = new LineInputStream(in);
